...
/**
 * Gibt Enumeration �ber alle Kanten zur�ck.
...
/**
 * Gibt die Kante zur�ck, dieer die angegebene ID besitzt.
 * Gibt es keine solche Kante, wird null zur�ckgegeben.
...
/**
 * Gibt die Geschwindigkeit der angegebenen Kantenklasse zur�ck.
...
/**
 * Gibt das Objekt zur Kantenbewertung zur�ck.
...
/**
 * Erzeugt neue Kante und f�gt diese in Container ein.
 * Existiert bereits eine Kante mit der angegebenen ID, wird diese statt dessen zur�ckgegeben.
...
/**
 * Gibt die Anzahl der gespeicherten Kanten zur�ck.
 * @return Anzahl
 */
 ...
 * @param in DataInput
 * @param nodes Container f�r Knoten
 */
