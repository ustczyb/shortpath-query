...
/**
 * Gibt das Darstellungsobjekt zur�ck, das den gleichen Namen hat und f�r den angegebenen Ma�stab gilt.
...
/**
 * Gibt das n�chste Darstellungsobjekt zur�ck, das den gleichen Namen hat.
...
/**
 * Gibt die Selektierbarkeit zur�ck.
 * @return selektierbar?
 */
...
/**
 * Gibt die Selektionsrandfarbe zur�ck.
 * @return Farbe
 */
...
/**
 * Gibt die Selektionsf�llfarbe zur�ck.
 * @return Farbe
 */
...
/**
 * Gibt die grunds�tzliche Sichtbarkeit zur�ck.
 * @return sichtbar?
 */
 ...
 * @param type Typ
 * @param size Gr��e in Pixel/Punkt
 */
 ...
 * @param minScale (eingeschlossener) Minimal-Ma�stab
 * @param maxScale (nicht mehr eingeschlossener) Maximal-Ma�stab
 */
 ...
 * @param selectionColor Selektionsrandfarbe
 * @param selectionFillColor Selektionsf�llfarbe
 */
...
/**
 * Schaltet die grunds�tzliche Sichtbarkeit an bzw. aus.
 * @return this
 * @param on sichtbar?
 */
