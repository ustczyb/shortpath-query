...
public class BufferedEntryReader extends BufferedReader implements EntryInput {
	...
	private final int maxBufferSize = 8192;		// dessen max. Gr��e
	...
	private int nextEntryLength = 0;				//	L�nge des n�chsten Eintrags, 0 = beliebig
	private char terminatingChar = '\t';			// Abschlu�-Zeichen
